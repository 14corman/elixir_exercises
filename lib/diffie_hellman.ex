defmodule Exercises.DiffieHellman do
  @moduledoc """
  ...
  def generate_shared_secret(prime_p, public_key_b, private_key_a) do
    pow(public_key_b, private_key_a)
    |> rem(prime_p)
  end

  # Found out: https://stackoverflow.com/a/32030190/9659107 (by: Paweł Obrok)
  defp pow(_, 0), do: 1
  defp pow(x, n) when rem(n, 2) != 0, do: x * pow(x, n - 1)
  defp pow(x, n) do
